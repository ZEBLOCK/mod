...
public class GuiConnecting extends ArouseScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ArouseButtonWithBG(0, 0, this.height / 4 + 120 + 12, this.width,20,I18n.getString("gui.cancel")));
    }
