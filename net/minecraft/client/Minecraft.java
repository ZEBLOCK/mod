...
import net.zeblock.arouse.gui.ArouseMainGui;
import net.zeblock.arouse.gui.LoginGui;

@SideOnly(Side.CLIENT)
public class Minecraft implements IPlayerUsage
{
	public int checkZEGui=0;
    ...
    private void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft 1.6.4 _Welcome "+this.getSession().getUsername()+" to ZEblock" );
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new ArouseMainGui(), this, this.serverName, this.serverPort));
        }
        else
        {
    ...
    public void displayGuiScreen(GuiScreen par1GuiScreen)
    {
        ...
        if (checkZEGui == 1&& this.theWorld != null){
        	par1GuiScreen =new LoginGui(0);
        	checkZEGui=0;
        }
        if (checkZEGui == 2&& this.theWorld != null){
        	par1GuiScreen =new LoginGui(2);
        	checkZEGui=0;
        }
        ...
        {
            par1GuiScreen = new ArouseMainGui();
        }
