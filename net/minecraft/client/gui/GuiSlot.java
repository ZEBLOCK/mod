...
protected static final ResourceLocation bg= new ResourceLocation("arouse:bg.png");
	...
	public void de(double d, double y, int u, double w, double nimgh, double w2, double w3, double imgw){
        ...
        tessellator.addVertexWithUV((double)(d + 0), (double)(y + w2), (double)0, (double)((float)(u + 0) * f), (double)((float)(w + w2) * f));
        tessellator.addVertexWithUV((double)(d + nimgh), (double)(y + w2), (double)0, (double)((float)(u + nimgh) * f), (double)((float)(w + w2) * f));
        tessellator.addVertexWithUV((double)(d + nimgh), (double)(y + 0), (double)0, (double)((float)(u + nimgh) * f), (double)((float)(w + 0) * f));
        tessellator.addVertexWithUV((double)(d + 0), (double)(y + 0), (double)0, (double)((float)(u + 0) * f), (double)((float)(w + 0) * f));
        tessellator.draw();
    }
