...
import net.zeblock.arouse.gui.WRONGPASS;
...
public class GuiNewChat extends Gui
{
    ...
    {
    	String check = par1Str;
    	if (check.equals("§cneedLogin")||check=="§cneedLogin"){
    		mc.checkZEGui= 1;
    	} 
    	else if(check=="§cneedRegister"){
    		mc.checkZEGui= 2;
    	}
    	else if(check.equals("§cWRONGPASS")||check=="§cWRONGPASS"){
    		mc.displayGuiScreen(new WRONGPASS());
    	}
    	else if(check.equals("§aLoggedInSuc")||check=="§aLoggedInSuc" ){
    		mc.checkZEGui= 0;
