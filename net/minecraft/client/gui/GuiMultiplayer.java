...
import net.zeblock.arouse.gui.ArouseScreen;

import org.lwjgl.input.Keyboard;

@SideOnly(Side.CLIENT)
public class GuiMultiplayer extends ArouseScreen
{
    ...
    private ServerData dx;
    private ServerData wt;
    private ServerData yd;
    ...
    public void initGui()
    {
        ...
        if (!this.field_74024_A)
        {
            ...
            dx = new ServerData("ZEblock电信入口", "192.168.0.104");
            this.dx.setHideAddress(true);
            this.internetServerList.addServerData(dx);
            
            wt = new ServerData("ZEblock电信入口", "192.168.0.104");
            this.wt.setHideAddress(true);
            this.internetServerList.addServerData(wt);
            
            yd = new ServerData("ZEblock电信入口", "192.168.0.104");
            this.yd.setHideAddress(true);
            this.internetServerList.addServerData(yd);
    ...
    {
        //this.buttonList.add(this.field_96289_p = new ArouseButtonWithBG(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.getString("selectServer.edit")));
        //his.buttonList.add(this.buttonDelete = new ArouseButtonWithBG(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.getString("selectServer.delete")));
        this.buttonList.add(this.buttonSelect = new ArouseButtonWithBG(1, this.width / 2 - 50, this.height - 52, 100, 20, I18n.getString("selectServer.select")));
        //this.buttonList.add(new ArouseButtonWithBG(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.getString("selectServer.direct")));
        //this.buttonList.add(new ArouseButtonWithBG(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.getString("selectServer.add")));
        this.buttonList.add(new ArouseButtonWithBG(8, this.width / 2 - 154, this.height - 52, 100, 20, I18n.getString("selectServer.refresh")));
        this.buttonList.add(new ArouseButtonWithBG(0, this.width / 2 + 4 + 50, this.height - 52, 100, 20, "返回"));
