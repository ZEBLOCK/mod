...
public class ArouseTF extends Gui
{
    /**
    ...
    public ArouseTF(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5)
    {
    ...
    public void drawTextBox()
    {
        ...
        if (this.getVisible())
        {
            ...
            {
            	drawRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, 0x50000000);
            }
            ...
            if(this.getText()!="输入密码..."){
            	if (this.ispassword)
            	{
            		...
            		String ns = "";
            		for (int n = 0; n < len; ++n){
            			int r = this.rand.nextInt(26);
            			r += 65;
            			String nc = String.valueOf((char)r);
            			ns = ns + nc;
            		}
            		s = ns;
            	}
